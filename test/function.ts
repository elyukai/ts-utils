...
import { andEvery, bind, constant, identity, not, on, orSome } from "../src/function.js"
...
describe("on", () => {
  it("combines two values using an accessor and a combinator", () => {
    interface Person {
      name: string
      age: number
    }
    ...
    const combineAges = on(getAge, sum)
