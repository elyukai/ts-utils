 ...
 */
export const isNaturalNumber = (test: string) => naturalNumberPattern.test(test)

/**
 * Checks if the provided string is a string representation of an integer.
 * @param test The string to test.
 */
export const isInteger = (test: string) => integerPattern.test(test)
 ...
 * @param test The string to test.
 */
export const isFloat = (test: string) => floatPattern.test(test)
